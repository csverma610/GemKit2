...
class GeminiClient:
    """
    A client for interacting with the Gemini API through an OpenAI-compatible endpoint.

    This class provides a simplified interface for sending prompts to the Gemini API
    and receiving text responses, using the `openai` library to handle the
    communication.
    """
    ...
    def generate_text(self, user_prompt: str, assist_prompt: str = "", sys_prompt: str = "") -> str:
        ...
        Args:
            ...
            assist_prompt (str, optional): An optional assistant message to provide
                                           few-shot examples or context.
            sys_prompt (str, optional): An optional system-level instruction to guide
